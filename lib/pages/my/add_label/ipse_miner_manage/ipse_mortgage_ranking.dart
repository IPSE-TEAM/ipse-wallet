...
class IpseMortgageRanking extends StatefulWidget {
  IpseMortgageRanking(this.appStore);
  static String route = "/my/IpsemortgageRanking";
  final AppStore appStore;
  @override
  _IpseMortgageRankingState createState() => _IpseMortgageRankingState(appStore);
}

class _IpseMortgageRankingState extends State<IpseMortgageRanking> {
  _IpseMortgageRankingState(this.store);
