...
import 'package:ipsewallet/widgets/address_icon.dart';import 'package:ipsewallet/widgets/validator_list_filter.dart';
...
class _NominatePageState extends State<NominatePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: myAppBar(context, dic['action.nominate']),
