...
import 'package:ipsewallet/pages/my/staking/validators/validator.dart';
...
import 'package:ipsewallet/widgets/text_tag.dart';
import 'package:ipsewallet/widgets/validator_list_filter.dart';
...
class _StakingOverviewPageState extends State<StakingOverviewPage>
  ...
  Widget _buildTopCard(BuildContext context) {
    ...
    bool isStash = true;
    if (hashData) {
      bonded = BigInt.tryParse(store.staking.ownStashInfo.stakingLedger['active'].toString());
