...
mixin _$StakingStore on _StakingStore, Store {
  ...
  @override
  ObservableList<StakingTxData> get txs {
    _$txsAtom.reportRead();
    return super.txs;
  }

  @override
  set txs(ObservableList<StakingTxData> value) {
  ...
  @override
  ObservableList<StakingTxRewardData> get txsRewards {
    _$txsRewardsAtom.reportRead();
    return super.txsRewards;
  }

  @override
  set txsRewards(ObservableList<StakingTxRewardData> value) {
  ...
  @override
  Future<void> addTxs(List<dynamic> res, {bool shouldCache = false}) {
  ...
  @override
  Future<void> addTxsRewards(List<dynamic> res, {bool shouldCache = false}) {
